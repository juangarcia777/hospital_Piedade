...
<div class="content_meio">
    ...
    <div class="tp_interna">
    	TERMO DE FOMENTO 07 (PLANTÃO) - 2019
    </div>	 
    ...
    <?php
		...
		?>
			...
			<?php
                $sql2 = $db->select("SELECT * FROM a_documentos_fomento_quimio_7 WHERE tipo='$tipo' AND ano = '2019' ORDER BY ordem DESC");
       ...
       <div class="tp_interna">
        TERMO DE FOMENTO 14 (QUIMIOTERAPIA) - 2019
        </div>   
    ...
    <?php
        ...
        ?>
            ...
            <div class="titulos22km"><?php echo 'TERMO DE FOMENTO 14'; ?></div>
            <div class="ajusta_line22km"><div class="line22km"></div></div>
                
            <?php
                $sql2 = $db->select("SELECT * FROM a_documentos_fomento_quimio_15 WHERE tipo='$tipo' AND ano = '2019' ORDER BY ordem DESC");
                while($ln2=$db->expand($sql2)){  
            ?>
