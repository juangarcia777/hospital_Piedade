...
<ul>
    ...
    <li id="menu01">
        ...
        <div class="sub01" style="height: auto;">
            ...
            <a href="<?php echo $root_doc; ?>missao-visao-valores" class="submenu">MISSÃO, VISÃO E VALORES</a>
             ...
             <div id="menu99" class="submenu">TRANSPARÊNCIA<i class="fa fa-angle-right fa-fw poy" aria-hidden="true"></i>
             
                 <div class="subsub">
                    <a href="<?php echo $root_doc; ?>documentos-probatorios" class="submenu2">DOCUMENTOS PROBATÓRIOS</a>    
    ...
    <li id="menu04">
        CORPO CLÍNICO&nbsp;<i class="fa fa-angle-down fa-fw" aria-hidden="true"></i>
        <div class="sub04">
            <a href="<?php echo $root_doc; ?>especialidades" class="submenu">ESPECIALIDADES</a>
        </div>
    </li>
    
    <a href="<?php echo $root_doc; ?>noticias" style="display:none"><li>NOTÍCIAS</li></a>
