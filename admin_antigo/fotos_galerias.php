...
if(isset($_GET['action']) && $_GET['action']==22){
	...
	if($resposta==1){
		$grava = mysql_query("INSERT INTO fotos_albuns (id_album, foto) VALUES ('$id', '$nm_new')");	
	...
	$exclui = mysql_query("DELETE FROM fotos_albuns WHERE id='$id_foto' LIMIT 1");
...
$pega = mysql_query("SELECT titulo FROM albuns WHERE id='$id' LIMIT 1");
...
<tr>
<td align="left"><span class="titu">:: Enviando<b> fotos </b>para o álbum: <b><?php echo(strip_tags($row['titulo'])); ?></b></span></td>
</tr>
...
<form method="post" action="fotos_galerias.php?action=22" enctype="multipart/form-data">	
<table cellpadding="0" cellspacing="0" width="100%" >
...
<tr><td align="right"><span class="titu">Fotos cadastradas no álbum <b><?php echo(strip_tags($row['titulo'])); ?></b> ::</span></td></tr>
<tr><Td height="4"></Td></tr>
...
$pega2 = mysql_query("SELECT * FROM fotos_albuns WHERE id_album='$id' ORDER BY id DESC");
