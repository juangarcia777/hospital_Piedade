...
if(isset($_GET['action']) && $_GET['action']==1){
	...
	if(!empty($categoria)){
		...
		$grava = mysql_query("INSERT INTO marca (Nome) VALUES ('$categoria')");	
...
//FAZ A PESQUISA PARA ALTERAÇĂO NO BANCO DE DADOS	
	...
	$select = mysql_query("SELECT * FROM marca WHERE Id='$id' LIMIT 1");
...
//FAZ A exclusăo NO BANCO DE DADOS		
	...
	$exclui = mysql_query("DELETE FROM marca WHERE Id='$id' LIMIT 1");
...
//FAZ A ALTERAÇĂO NO BANCO DE DADOS		
	...
	if(!empty($categoria)){
		...
		$grava = mysql_query("UPDATE marca SET Nome='$categoria' WHERE Id='$id' LIMIT 1");	
...
<tr><td><span class="titu">:: Cadastro de Horários das Aulas</span></td></tr>
...
<tr><td><span class="tex2">Horários:</span><span class="obs"> (Ex: Seg a Sex: 07:00 ás 9:00 e Sab: 09:00 ás 12:00)</span></td></tr>
...
<tr><td align="right"><span class="titu">Alteraçăo/Exclusăo de Tipos de Produtos</span></td></tr>
<tr><Td height="4"></Td></tr>
<tr><Td style="border-bottom:1px dotted #09C"></Td></tr>
<tr><Td height="4"></Td></tr>
</table>
...
<?php
	$pega = mysql_query("SELECT * FROM marca ORDER BY Id DESC");
